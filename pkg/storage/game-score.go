...
func GetMatchGamesScores(db *sql.DB, id int) ([]*core.GameScore, error) {
	var scores []*core.GameScore
...
func AddMatchGamesScores(db *sql.DB, scores core.GameScores) error {
